...
import { googleMapsDirectionsUrl, googleMapsItineraryUrl, travelEstimateNotice } from './map-provider';
...
it('labels fallback travel estimates for the UI', () => expect(travelEstimateNotice({ distanceMeters: 1000, durationSeconds: 600, source: 'HAVERSINE' })).toContain('ước tính'));
