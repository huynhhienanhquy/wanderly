import { registerRequestSchema } from '@wanderly/contracts';
...
export default function RegisterScreen() {
  ...
  async function submit() {
    ...
    try {
      ...
      if (!response.ok) throw new Error(body.message ?? 'Không thể đăng ký.');
      setMessage(`Chào mừng ${body.user?.displayName ?? displayName}!`);
    } catch (error) {
